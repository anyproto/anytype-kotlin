...
val CustomIcons.CiPersonRemove: ImageVector
    get() {
        if (_CiPersonRemove != null) {
            return _CiPersonRemove!!
        }
        _CiPersonRemove = ImageVector.Builder(
            name = "CiPersonRemove",
            defaultWidth = 512.dp,
...
private var _CiPersonRemove: ImageVector? = null
