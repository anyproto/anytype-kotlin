...
class BlockDataRepository(
    ...
    override suspend fun readChatMessages(command: Command.ChatCommand.ReadMessages) {
        remote.readChatMessages(command)
    }

    override suspend fun readAllMessages() {
        remote.readAllMessages()
    }
    ...
    override suspend fun getChatMessages(command: Command.ChatCommand.GetMessages): Command.ChatCommand.GetMessages.Response {
    ...
    override suspend fun createObjectFromUrl(
        ...
        url: Url,
        createdInContext: Id?
    ): ObjectWrapper.Basic = remote.createObjectFromUrl(
        space = space,
        url = url,
