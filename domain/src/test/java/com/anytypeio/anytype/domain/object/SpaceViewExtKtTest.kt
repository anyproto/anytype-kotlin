...
class SpaceViewExtKtTest {
    ...
    // CHAT space type tests were removed: CHAT-type spaces can no longer be
    // created (all pre-existing records were migrated to REGULAR by middleware),
    // so the CHAT-space limit-bypass in canAddWriters / canAddReaders /
    // canChangeReaderToWriter has been deleted along with its tests.
