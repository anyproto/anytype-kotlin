...
class DefaultStoreOfObjectTypesTest {
    ...
    private fun structOfId(id: Id): Struct = mapOf("id" to id)
    ...
    // --- OPTIONAL: sanity checks around observe(id) if your ObjectWrapper_Type isValid == true with minimal Struct ---
