...
interface AppNavigation {
    ...
    fun exitToVault()
    fun exitToSpaceHome()
    fun popToBackStackEntry(entryId: String)
    ...
    sealed class Command {
        ...
        data class PopToBackStackEntry(val entryId: String) : Command()
        ...
        data class OpenDiscussion(val target: Id, val space: Id) : Command()
