                    ...
                    expected = WidgetView.Tree(
                        ...
                        elements = listOf(
                            WidgetView.Tree.Element(
                                ...
                                objectIcon = ObjectIcon.Profile.Avatar(sourceLinks[0].name.orEmpty())
                            ),
                            WidgetView.Tree.Element(
                                indent = 0,
                                obj = sourceLinks[1],
                                ...
                                objectIcon = ObjectIcon.Profile.Avatar(sourceLinks[1].name.orEmpty())
                            ),
                            WidgetView.Tree.Element(
                                indent = 0,
                                obj = sourceLinks[2],
                                ...
                                elementIcon = WidgetView.Tree.ElementIcon.Leaf,
                                objectIcon = ObjectIcon.Profile.Avatar(sourceLinks[2].name.orEmpty())
                            )
                        ),
                        isExpanded = true
                    ),
                    ...
                    expected = WidgetView.Tree(
                        ...
                        elements = listOf(
                            ...
                            WidgetView.Tree.Element(
                                ...
                                elementIcon = WidgetView.Tree.ElementIcon.Leaf,
                                objectIcon = ObjectIcon.Profile.Avatar(linkA1.name.orEmpty())
                            ),
                            WidgetView.Tree.Element(
                                indent = 1,
                                obj = linkA2,
                                ...
                                elementIcon = WidgetView.Tree.ElementIcon.Leaf,
                                objectIcon = ObjectIcon.Profile.Avatar(linkA2.name.orEmpty())
                            ),
                            WidgetView.Tree.Element(
                                indent = 1,
                                obj = linkA3,
                                ...
                                elementIcon = WidgetView.Tree.ElementIcon.Leaf,
                                objectIcon = ObjectIcon.Profile.Avatar(linkA3.name.orEmpty())
                            ),
                            WidgetView.Tree.Element(
                                indent = 0,
                                obj = sourceLinks[1],
